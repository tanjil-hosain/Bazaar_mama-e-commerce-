...
<html lang="en">
<head>
    <meta charset="UTF-8"><title>BazaarMama - Register</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="bg-light d-flex align-items-center" style="height: 100vh;">
    <div class="container" style="max-width: 450px;">
        <?php if(!empty($msg)): ?> <div class="alert alert-<?= $type ?>"><?= $msg ?></div> <?php endif; ?>
        <div class="card shadow-lg border-0">
            <div class="card-body p-4">
                <h3 class="fw-bold text-center mb-4">📝 Join BazaarMama</h3>
                <form action="" method="POST">
                    ...
                    <button type="submit" name="registration" class="btn btn-info text-white w-100 fw-bold py-2 mb-3">Create Account</button>
